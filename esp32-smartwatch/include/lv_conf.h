...
#define LV_USE_KEYBOARD 0       // Disabled for space
#define LV_USE_LABEL 1
#define LV_USE_LED 1
#define LV_USE_LINE 1
#define LV_USE_LIST 1
#define LV_USE_MENU 0           // Disabled for space
#define LV_USE_MSGBOX 1
#define LV_USE_OBJX_TEMPLATES 0 // Disabled for space
#define LV_USE_ROLLER 1
#define LV_USE_SLIDER 1
#define LV_USE_SPINBOX 1
#define LV_USE_SPINNER 1
#define LV_USE_SWITCH 1
#define LV_USE_TEXTAREA 0       // Disabled for space
#define LV_USE_TABLE 0          // Disabled for space
#define LV_USE_TABVIEW 1
#define LV_USE_TILEVIEW 0       // Disabled for space
#define LV_USE_WIN 0            // Disabled for space
